 ...
 */let pi;function Ze(t){return(e,o)=>Ho(e,o,{get(){return(this.renderRoot??pi??(pi=document.createDocumentFragment())).querySelectorAll(t)}})}var hi=Object.defineProperty,ui=Object.getOwnPropertyDescriptor,l=(t,e,o,r)=>{for(var i=r>1?void 0:r?ui(e,o):e,n=t.length-1,a;n>=0;n--)(a=t[n])&&(i=(r?a(e,o,i):a(i))||i);return r&&i&&hi(e,o,i),i},Fe=class extends S{connectedCallback(){super.connectedCallback()}render(){var t,e,o,r,i,n,a,h,p,f,m,g,V,v,P,j,z,N,L,M,H,k,F,q,J,Y,K,X,G,tt,et,W,I,gt,at,yt,s,d,y,b,A,R,$,Q,O,bt,Lt,Mt,Bt,Dt,Nt,Ht,Ft,Ut,Tt,qt,Yt,Gt,Wt,Xt,Qt,Jt,Kt,It,Zt,te,ee,oe,ie,re,se,ne,ae,le,ce,de,pe,he,ue,fe,me,ge,ye;return u`
            <style>
                :host{
                    ...
                    background-image: ${((d=this.decoration)==null?void 0:d.backgroundImage)===void 0?(y=this.decoration)==null?void 0:y.backgroundGradientColor:((b=this.decoration)==null?void 0:b.backgroundImage)!=="none"&&((A=this.decoration)==null?void 0:A.backgroundGradientColor)===void 0?`url(${(R=this.decoration)==null?void 0:R.backgroundImage})`:($=this.decoration)==null?void 0:$.backgroundGradientColor};
                    background-size:            ${((Q=this.decoration)==null?void 0:Q.backgroundSize)===void 0?"":((O=this.decoration)==null?void 0:O.backgroundSize)!=="none"?"cover":"initial"};
        ...
        `}};l([c()],dt.prototype,"label",2);l([c({type:Boolean})],dt.prototype,"checked",2);l([c({attribute:!1})],dt.prototype,"checkBoxStyle",2);l([c({attribute:!1})],dt.prototype,"labelStyle",2);l([c({attribute:!1})],dt.prototype,"onChanged",2);l([c({attribute:!1})],dt.prototype,"size",2);dt=l([C("ecv-checkbox")],dt);var Se=class extends S{constructor(){super(...arguments),this.size="48px",this.backgroundImage="none",this.color="transparent"}render(){return u`
            ...
            <slot></slot>
        `}};l([c({type:String})],Se.prototype,"size",2);l([c({type:String})],Se.prototype,"backgroundImage",2);l([c({type:String})],Se.prototype,"color",2);Se=l([C("ecv-circle-box")],Se);var Re=class extends S{constructor(){super(...arguments),this.width="100%"}render(){return u`
            <style>
                :host{
                    width: ${this.width}
                }
    ...
    `;l([c()],Re.prototype,"width",2);Re=l([C("ecv-divisor")],Re);var Ue=class extends S{constructor(){super(...arguments),this.flex="1"}render(){var t,e;return u`
            <style>
                :host{
                    display: block;
                    flex: ${this.flex};
    ...
    `;l([T()],wt.prototype,"materailSymbolsAddress",2);l([c()],wt.prototype,"icon",2);l([c({type:Boolean})],wt.prototype,"filled",2);l([c({attribute:!1})],wt.prototype,"iconStyle",2);wt=l([C("ecv-icon")],wt);var St=class extends S{constructor(){super(...arguments),this.icon="favorite",this.onPressed=()=>{}}render(){var t,e,o,r,i,n,a,h,p,f,m,g;return u`
        ...
        `}};l([c({attribute:!1})],St.prototype,"icon",2);l([c({attribute:!1})],St.prototype,"onPressed",2);l([c({attribute:!1})],St.prototype,"hoverState",2);l([c({attribute:!1})],St.prototype,"buttonStyle",2);l([c({attribute:!1})],St.prototype,"iconStyle",2);St=l([C("ecv-icon-button")],St);var Rt=class extends S{constructor(){super(...arguments),this.source="",this.description=""}render(){var t,e,o,r,i,n,a,h,p;return u`
            <style>
    ...
    `;l([c()],ut.prototype,"all",2);l([c()],ut.prototype,"top",2);l([c()],ut.prototype,"right",2);l([c()],ut.prototype,"left",2);l([c()],ut.prototype,"bottom",2);ut=l([C("ecv-padding")],ut);var rt=class extends S{constructor(){super(...arguments),this.position="relative",this.left="auto",this.right="auto",this.top="auto",this.bottom="auto",this.zIndex="auto",this.width="fit-content",this.height="fit-content"}render(){return u`
        ...
        `}};l([c({attribute:!1})],nt.prototype,"onPressed",2);l([c({attribute:!1})],nt.prototype,"icon",2);l([c({type:Boolean})],nt.prototype,"reversePosition",2);l([c({attribute:!1})],nt.prototype,"buttonStyle",2);l([c({attribute:!1})],nt.prototype,"textStyle",2);l([c({attribute:!1})],nt.prototype,"hoverState",2);l([c({attribute:!1})],nt.prototype,"iconStyle",2);nt=l([C("ecv-text-button-icon")],nt);var Ot=class extends S{constructor(){super(...arguments),this.onPressed=()=>{}}render(){var t,e,o,r,i,n,a,h,p,f,m,g;return u`
            <style>
        ...
        `}};l([c({attribute:!1})],Ot.prototype,"onPressed",2);l([c({attribute:!1})],Ot.prototype,"hoverState",2);l([c({attribute:!1})],Ot.prototype,"buttonStyle",2);l([c({attribute:!1})],Ot.prototype,"textStyle",2);Ot=l([C("ecv-text-button")],Ot);var kt=class extends S{constructor(){super(...arguments),this.hint="",this.label=""}render(){var t,e,o,r,i,n,a,h,p,f,m,g,V,v,P,j,z,N,L,M,H,k,F;return u`
            <style>
                :host{
                    display: block;
                }
        ...
        `}};l([c({attribute:!1})],Ye.prototype,"textStyle",2);Ye=l([C("ecv-text")],Ye);var U=class extends S{constructor(){super(),this.rows="2",this.columns="2",this.hint="Placeholder",this.gap="",this.resizeble=!1}render(){var t,e,o,r,i,n,a,h,p,f,m,g,V,v,P,j,z,N,L,M,H,k,F,q,J,Y,K,X,G,tt,et,W,I,gt,at,yt,s,d,y,b,A,R,$,Q,O,bt,Lt,Mt,Bt,Dt,Nt,Ht,Ft,Ut,Tt,qt,Yt,Gt,Wt,Xt,Qt,Jt,Kt,It,Zt,te,ee,oe,ie,re,se,ne,ae,le,ce,de,pe,he,ue,fe,me,ge,ye,eo,oo,io,ro,so,no,ao,lo,co,po,ho,uo;return u`
            <style>
                    ...
                    textarea{
                        ...
                        margin-bottom:              ${((A=this.textAreaStyle)==null?void 0:A.marginBottom)===void 0?"0":(R=this.textAreaStyle)==null?void 0:R.marginBottom};
                        margin:                     ${(($=this.textAreaStyle)==null?void 0:$.marginAll)===void 0?"none":(Q=this.textAreaStyle)==null?void 0:Q.marginAll};
                        padding-left:               ${((O=this.textAreaStyle)==null?void 0:O.paddingLeft)===void 0?"0":(bt=this.textAreaStyle)==null?void 0:bt.paddingLeft};
        ...
        `}};ko=vi([C("l-home")],ko);const xi=""+new URL("pdf_icon-DxRu4FJM.png",import.meta.url).href,Ao=""+new URL("curriculum-Bqy0u5v3.pdf",import.meta.url).href;var $i=Object.defineProperty,wi=Object.getOwnPropertyDescriptor,Fo=(t,e,o,r)=>{for(var i=r>1?void 0:r?wi(e,o):e,n=t.length-1,a;n>=0;n--)(a=t[n])&&(i=(r?a(e,o,i):a(i))||i);return r&&i&&$i(e,o,i),i};let Ge=class extends S{constructor(){super(...arguments),this.body=document.querySelector("body")}static get styles(){return D`
            .curriculum{
                display: flex;
                flex-direction: column;
                align-items: center;
 ...
 */const ji=new Set(["children","localName","ref","style","className"]),Vo=new WeakMap,Ro=(t,e,o,r,i)=>{const n=i==null?void 0:i[e];n===void 0?(t[e]=o,o==null&&e in HTMLElement.prototype&&t.removeAttribute(e)):o!==r&&((a,h,p)=>{let f=Vo.get(a);f===void 0&&Vo.set(a,f=new Map);let m=f.get(h);p!==void 0?m===void 0?(f.set(h,m={handleEvent:p}),a.addEventListener(h,m)):m.handleEvent=p:m!==void 0&&(f.delete(h),a.removeEventListener(h,m))})(t,n,o)},Li=({react:t,tagName:e,elementClass:o,events:r,displayName:i})=>{const n=new Set(Object.keys(r??{})),a=t.forwardRef((h,p)=>{const f=t.useRef(new Map),m=t.useRef(null),g={},V={};for(const[v,P]of Object.entries(h))ji.has(v)?g[v==="className"?"class":v]=P:n.has(v)||v in o.prototype?V[v]=P:g[v]=P;return t.useLayoutEffect(()=>{if(m.current===null)return;const v=new Map;for(const P in V)Ro(m.current,P,h[P],f.current.get(P),r),f.current.delete(P),v.set(P,h[P]);for(const[P,j]of f.current)Ro(m.current,P,void 0,j,r);f.current=v}),t.useLayoutEffect(()=>{var v;(v=m.current)==null||v.removeAttribute("defer-hydration")},[]),g.suppressHydrationWarning=!0,t.createElement(e,{...g,ref:t.useCallback(v=>{m.current=v,typeof p=="function"?p(v):p!==null&&(p.current=v)},[p])})});return a.displayName=i??o.name,a};var Mi=Object.defineProperty,Bi=Object.getOwnPropertyDescriptor,_=(t,e,o,r)=>{for(var i=r>1?void 0:r?Bi(e,o):e,n=t.length-1,a;n>=0;n--)(a=t[n])&&(i=(r?a(e,o,i):a(i))||i);return r&&i&&Mi(e,o,i),i},At=class extends S{constructor(){super(...arguments),this.filled=!1,this.size=24,this.color="black"}connectedCallback(){super.connectedCallback(),this.ensureFontLoaded()}ensureFontLoaded(){if(!document.getElementById("material-symbols-font")){const t=document.createElement("link");t.id="material-symbols-font",t.rel="stylesheet",t.href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@48,400,1,0",document.head.appendChild(t)}}hiddenIcon(){this.style.display="none"}showIcon(){this.style.display="block"}render(){return u`
        ...
        `}};to([E("l-modal-project")],Oe.prototype,"lModalProject",2);to([c({attribute:!1})],Oe.prototype,"project",2);Oe=to([C("l-card-project")],Oe);const Ui=""+new URL("icon_ecv-BeFJJLmH.png",import.meta.url).href,Ti=""+new URL("logo_lit_player-IDR7OvwI.png",import.meta.url).href,qi=[{title:"ECV Component",descriptionCard:`Biblioteca de Web Components desenvolvida em TypeScript para 
        ...
        `}};To([T()],Xe.prototype,"_projects",2);Xe=To([C("l-project")],Xe);const Wi=""+new URL("whatsapp-BtCgz4Tn.png",import.meta.url).href,Xi=""+new URL("gmail-5foEKrqW.png",import.meta.url).href;var Qi=Object.getOwnPropertyDescriptor,Ji=(t,e,o,r)=>{for(var i=r>1?void 0:r?Qi(e,o):e,n=t.length-1,a;n>=0;n--)(a=t[n])&&(i=a(i)||i);return i};let zo=class extends S{static get styles(){return D`
            p{
                margin: 0;
                padding: 0;
            }
